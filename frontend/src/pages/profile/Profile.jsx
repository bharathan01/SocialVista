              ...
              <div className="w-full flex flex-col gap-1 mt-[10px]">
                ...
                <div className="sm:ml-[50px] ml-[30px]">
                  <span className="lg:text-base text-sm">
                    ...
                    ducimus sequi, nam commodi accusamus id, molestias labore
                    eum officia laborum deleniti dicta! Molestiae, ipsa soluta
                    sed hic saepe accusantium officia eum ea, possimus pariatur
                    sint reprehenderit corrupti itaque quae.
                  </span>
                </div>
              </div>
